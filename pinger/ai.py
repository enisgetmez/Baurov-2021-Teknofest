...
def ai_baslat():
    ...
    for i in range(0,50):
        ...
        if(data_2 == True):
            ...
            print("rotate2 : ",rotate2)
            #x_r0 = 327-320
            #y_r0 = 240-242

            x_r0 = 0
            y_r0 = 0
            #x_r_prime = x_r0*np.cos(rotate2*180/np.pi)+y_r0*np.sin(rotate2*180/np.pi)
            #y_r_prime = y_r0*np.cos(rotate2*180/np.pi)-x_r0*np.sin(rotate2*180/np.pi)
            #angle_final = np.arctan2((240-y_r_prime-(boxes_2[0][1]+boxes_2[0][3]/2)),((boxes_2[0][0]+boxes_2[0][2]/2)-320-x_r_prime))
            angle_final = np.arctan2((240-y_r0-(boxes_2[0][1]+boxes_2[0][3]/2)),((boxes_2[0][0]+boxes_2[0][2]/2)-320-x_r0 ))

            distance_1 = math.sqrt(((boxes_2[0][0]+boxes_2[0][2]/2)-320-x_r0)**2+(240-y_r0-(boxes_2[0][1]+boxes_2[0][3]/2))**2)*px_to_mt
            #distance_1 = math.sqrt(((boxes_2[0][0]+boxes_2[0][2]/2)-320-x_r_prime)**2+(240-y_r_prime-(boxes_2[0][1]+boxes_2[0][3]/2))**2)*px_to_mt
